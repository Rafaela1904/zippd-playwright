...
async function customerLoginTest() {
...
await btn.click();
    ...
    const signInDriverBtn = await driver.$('~Sign in to my customer account');
await signInDriverBtn.waitForDisplayed({ timeout: 10000 });
await signInDriverBtn.click();

console.log("👉 Tapped Sign in as Customer");

    console.log("👉 On Customer Login Screen");
...
await fields[0].setValue('rafaelamaelejana@gmail.com');
